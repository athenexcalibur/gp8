...
\requirement{Resetting Password}
...
\requirement{Viewing Listings Page}
...
\requirement{Commenting on a listing}
\label{fr:comments}
...
\requirement{Filtering Search Results}
\label{fr:filters}
...
\requirement{Viewing the User’s Past \& Current Listings Page}
...
\requirement{Committing to collect}
\label{fr:commit}
...
\requirement{Saving items for later}
\label{fr:watchlist}
